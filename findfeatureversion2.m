...
T = input('Please input the data file''s name for extracting features:');
...
for i = 1:N
    s1 = ['data.anr.a',num2str(i),' = (data.a.a',num2str(i),');'];
...
%     s8 = ['dh.d',num2str(i),' = [];'];
%     s9 = ['di.d',num2str(i),' = [];'];
    s6 = ['dh.f',num2str(i),' = data.s.f',num2str(i),'(:,label.hl',num2str(i),');'];
    s7 = ['di.f',num2str(i),' = data.s.f',num2str(i),'(:,label.il',num2str(i),');'];
    s8 = ['dh.Sp',num2str(i),' = data.s.Sp',num2str(i),'(:,label.hl',num2str(i),');'];
    s9 = ['di.Sp',num2str(i),' = data.s.Sp',num2str(i),'(:,label.il',num2str(i),');'];
    s10 = ['dh.So',num2str(i),' = data.s.So',num2str(i),'(:,label.hl',num2str(i),');'];
    s11 = ['di.So',num2str(i),' = data.s.So',num2str(i),'(:,label.il',num2str(i),');'];
    s12 = ['dh.Pul',num2str(i),' = data.s.Pul',num2str(i),'(:,label.hl',num2str(i),');'];
    s13 = ['di.Pul',num2str(i),' = data.s.Pul',num2str(i),'(:,label.il',num2str(i),');'];
    s14 = ['dh.lssp',num2str(i),' = dh.Sp',num2str(i),'(1:end,:);'];
    s15 = ['di.lssp',num2str(i),' = di.Sp',num2str(i),'(1:end,:);'];
    s16 = ['dh.lsf',num2str(i),' = dh.f',num2str(i),'(1:end,:);'];
    s17 = ['di.lsf',num2str(i),' = di.f',num2str(i),'(1:end,:);'];
...
for i = 1:N
    ...
    s11 = ['f.h.nl92',num2str(i),' = Findlow(dh.lssp',num2str(i),',92);'];
    s12 = ['f.i.nl92',num2str(i),'= Findlow(di.lssp',num2str(i),',92);'];
    s13 = ['f.h.nl91',num2str(i),' = Findlow(dh.lssp',num2str(i),',91);'];
    s14 = ['f.i.nl91',num2str(i),' = Findlow(di.lssp',num2str(i),',91);'];
    s15 = ['f.h.nl90',num2str(i),' = Findlow(dh.lssp',num2str(i),',90);'];
    s16 = ['f.i.nl90',num2str(i),' = Findlow(di.lssp',num2str(i),',90);'];
...
%     s28 = ['f.i.fmax',num2str(i),' = max(di.lsf',num2str(i),');'];
    s29 = ['f.h.nl93',num2str(i),' = Findlow(dh.lssp',num2str(i),',93);'];
    s30 = ['f.i.nl93',num2str(i),' = Findlow(di.lssp',num2str(i),',93);'];
    ...
    s51 = ['f.h.ftk',num2str(i),' = f.h.fft',num2str(i),'(5:15,:);'];
    s52 = ['f.i.ftk',num2str(i),' = f.i.fft',num2str(i),'(5:15,:);'];
    ...
    s59 = ['f.h.nlmean',num2str(i),' = Findlow(dh.lssp',num2str(i),',mean(dh.lssp',num2str(i),'));'];
    s60 = ['f.i.nlmean',num2str(i),' = Findlow(di.lssp',num2str(i),',mean(di.lssp',num2str(i),'));'];
    s201 = ['f.h.fsum',num2str(i),' = sum(abs(dh.lsf',num2str(i),'));'];
    s202 = ['f.i.fsum',num2str(i),' = sum(abs(di.lsf',num2str(i),'));'];
    s203 = ['f.h.dsumi',num2str(i),' = sum(abs(dh.lsf',num2str(i),'(1:data.T*rfs/3,:)))-sum(abs(dh.lsf',num2str(i),'(data.T*rfs/3+1:data.T*rfs*2/3,:)));'];
    s207 = ['f.h.dsumii',num2str(i),' = sum(abs(dh.lsf',num2str(i),'(data.T*rfs/3+1:data.T*rfs*2/3,:)))-sum(abs(dh.lsf',num2str(i),'(data.T*2*rfs/3+1:end,:)));'];
    s204 = ['f.i.dsumi',num2str(i),' = sum(abs(di.lsf',num2str(i),'(1:data.T*rfs/3,:)))-sum(abs(di.lsf',num2str(i),'(data.T*rfs/3+1:data.T*rfs*2/3,:)));'];
    s208 = ['f.i.dsumii',num2str(i),' = sum(abs(di.lsf',num2str(i),'(data.T*rfs/3+1:data.T*rfs*2/3,:)))-sum(abs(di.lsf',num2str(i),'(data.T*2*rfs/3+1:end,:)));'];
    s205 = ['f.h.fmax',num2str(i),' = max(f.h.fft',num2str(i),');'];
    s206 = ['f.i.fmax',num2str(i),' = max(f.i.fft',num2str(i),');'];
    s209 = ['f.h.fd',num2str(i),'(a) = MargaosSunKernel_FD(dh.lsf',num2str(i),'(:,a),1,1,100);'];
    s210 = ['f.i.fd',num2str(i),'(a) = MargaosSunKernel_FD(di.lsf',num2str(i),'(:,a),1,1,100);'];
    s211 = ['f.i.mu',num2str(i),' = abs(f.i.mu',num2str(i),');'];
...
% 
% for i = 1:100:l(3,1)
%     figure(),plot(dh.lsf1(:,i));
%     title(num2str(i));
% end
% for i = 1:100:l(3,1)
%     figure(),plot(f.h.fft1(:,i),'b--');
%     title(num2str(i));
% end
% for i = 1:30:l(2,1)
%     figure(),plot(di.lsf1(:,i),'r');
%     title(num2str(i));
% end
% for i = 1:30:l(2,1)
%     figure(),plot(f.i.fft1(:,i),'r--');
%     title(num2str(i));
% end